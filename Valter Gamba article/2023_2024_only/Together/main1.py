...
def reshape_dataset(file_path='Starting_Dataset.csv'):
    ...
    # 2. Create rename mapping dictionary
    rename_mapping = {
        'Field1_2023': 'Interviste_2023',
        'Field1_2024': 'Interviste_2024',
        'Field2_2023': 'Survey_Online_2023',
        'Field2_2024': 'Survey_Online_2024',
        'Field3_2023': 'Conference_Call_2023',
        'Field3_2024': 'Conference_Call_2024',
        'Field4_2023': 'Visite_In_Loco_2023',
        'Field4_2024': 'Visite_In_Loco_2024',
        'Field5_2023': 'Seminari_2023',
        'Field5_2024': 'Seminari_2024',
        'Field6_2023': 'Conferenze_2023',
        'Field6_2024': 'Conferenze_2024',
        'Field7_2023': 'Rapporti_Con_Agricoltori_2023',
        'Field7_2024': 'Rapporti_Con_Agricoltori_2024',
        'Field8_2023': 'Roadshow_2023',
        'Field8_2024': 'Roadshow_2024',
        'Field9_2023': 'Questionari_2023',
        'Field9_2024': 'Questionari_2024',
        'Field10_2023': 'Focus_Group_2023',
        'Field10_2024': 'Focus_Group_2024',
        'Field11_2023': 'Workshop_2023',
        'Field11_2024': 'Workshop_2024',
        'Field12_2023': 'Group_Meeting_2023',
        'Field12_2024': 'Group_Meeting_2024',
        'Field13_2023': 'Incontri_Periodici_2023',
        'Field13_2024': 'Incontri_Periodici_2024',
        'Field14_2023': 'Intranet_Aziendale_2023',
        'Field14_2024': 'Intranet_Aziendale_2024',
        'Field15_2023': 'Newsletters_2023',
        'Field15_2024': 'Newsletters_2024',
        'Field16_2023': 'Comunicati_Stampa_2023',
        'Field16_2024': 'Comunicati_Stampa_2024'
    }
...
# Based on the column structure, we have 16 fields (8 red, 5 blue, 3 green)
field_groups = {
    'Red_Group': {
        'fields': [f'Field{i}' for i in range(1, 9)],  # Fields 1-8
        'color_base': '#ff9800',  # Orange/amber
        'name': 'Fields 1-8',
        'max_fields': 8
    },
    'Blue_Group': {
        'fields': [f'Field{i}' for i in range(9, 14)],  # Fields 9-13
        'color_base': '#4d96ff',  # Blue
        'name': 'Fields 9-13',
        'max_fields': 5
    },
    'Green_Group': {
        'fields': [f'Field{i}' for i in range(14, 17)],  # Fields 14-16
        'color_base': '#6bcf7f',  # Green
        'name': 'Fields 14-16',
        'max_fields': 3
    }
}

# Rename columns to match expected structure (Field1_2023, Field1_2024, etc.)
# We have 16 fields for each year
field_names = [
    'Interviste', 'Survey_Online', 'Conference_Call', 'Visite_In_Loco',
    'Seminari', 'Conferenze', 'Rapporti_Con_Agricoltori', 'Roadshow',
    'Questionari', 'Focus_Group', 'Workshop', 'Group_Meeting',
    'Incontri_Periodici', 'Intranet_Aziendale', 'Newsletters', 'Comunicati_Stampa'
]

# Create mapping from field names to Field1-Field16
field_mapping = {}
for i, field in enumerate(field_names, 1):
    field_mapping[f'Field{i}_2023'] = f'{field}_2023'
    field_mapping[f'Field{i}_2024'] = f'{field}_2024'

# Create new columns with Field1_2023, Field1_2024, etc.
for i in range(1, 17):
    for year in ['2023', '2024']:
        if f'Field{i}_{year}' in field_mapping:
            original_col = field_mapping[f'Field{i}_{year}']
            if original_col in df.columns:
                df[f'Field{i}_{year}'] = df[original_col]
            else:
                # If column doesn't exist, fill with zeros
                df[f'Field{i}_{year}'] = 0

# Calculate sum of ones for each group and year (only 2023 and 2024)
...
# =============================================================================
# ENHANCED STATISTICAL ANALYSIS (ADAPTED FOR 2 YEARS)
# =============================================================================
...
# =============================================================================
# ADVANCED STATISTICAL ANALYSIS (ADAPTED FOR 2 YEARS)
# =============================================================================
...
def calculate_advanced_statistics():
    ...
    # Overall statistics (only 2023 and 2024)
    for year in ['2023', '2024']:
        year_stats = {
    ...
    # Trend analysis (2023 to 2024 only)
    trend_stats = {
...
def create_pdf_report():
    ...
    # Title page
    story.append(Paragraph("ATECO Sector Analysis - Enhanced Statistical Report (2023-2024)", title_style))
    ...
    story.append(Paragraph("Years Analyzed: 2023 and 2024 only", styles['Normal']))
    story.append(Spacer(1, 20))
