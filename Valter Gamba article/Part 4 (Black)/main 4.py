...
def comprehensive_database_reshaping(original_csv_path, ateco_codes_csv_path, output_csv_path='Tidier_Dataset.csv',
    ...
    #CAN CHANGE
    indicator_cols = [col for col in df.columns if col.startswith(('Field1_', 'Field2_', 'Field3_', 'Field4_', 'Field5_', 'Field6_', 'Field7_', 'Field8_'))]
...
# Calculate number of ones for each company each year (now with 5 fields)
for year in ['2022', '2023', '2024']:
...
# Color scheme for 1-5 ones (excluding 0) - extended for 5 fields
